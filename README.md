...
# Introduction
This is a mini application implementing REST CRUD operations using ASP.Net Web Api 2 with Entity Framework and Autofac.
...
- [Asp Web Api 2 + Autofac](https://github.com/melardev/.NetWebApiAutofacCrud)
...
- [Asp Web Api 2 + NHibernate](https://github.com/melardev/.NetWebApiADO.NetCrudPaginationCrudPagination)
